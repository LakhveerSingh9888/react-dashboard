    ...
    return (
        <InputLayout label={label} name={name} error={currentError}>
            <div className="relative" ref={containerRef}>
                ...
                {/* Dropdown */}
                {isOpen && (
                    <div className="absolute z-50 w-full mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg max-h-60 overflow-auto animate-in fade-in zoom-in-95 duration-100">
                        {options.length > 0 && (
                            <div
