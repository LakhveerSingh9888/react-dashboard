...
import {
    Home, BarChart2, Building2, Folder, Package, ShoppingCart, Users2, Wallet, Receipt,
    CreditCard, FileText, ImageIcon, Search, MessagesSquare, Video, Puzzle, Code, Layers,
    Database, Settings, HelpCircle, ChevronDown, TrendingUp, PieChart, Tag, Clock, Truck,
    Filter, Shield, Edit, Key, TrendingDown, Activity, Play,
} from 'lucide-react';
        ...
        items: [
            {
                ...
                children: [
                    { id: 'analytics', label: 'Analytics', href: '/dashboard/analytics', icon: BarChart2 },
                    {
                        ...
                        icon: FileText,
                        children: [
                            { id: 'sales-reports', label: 'Sales Reports', href: '/dashboard/reports/sales', icon: TrendingUp },
                            { id: 'user-reports', label: 'User Reports', href: '/dashboard/reports/users', icon: Users2 },
                        ],
                    },
                    { id: 'real-time', label: 'Real-time', href: '/dashboard/realtime', icon: Activity, isNew: true },
                ],
            },
            {
                id: 'analytics',
            ...
            {showText && (
                <>
                    ...
                    <div className="flex items-center space-x-1">
                        ...
                        {item.badge && (
                            <Badge variant="info" className="px-1.5 py-0.5 text-xs">{item.badge}</Badge>
                        )}
                        {showExpandIcon && (
                            <ChevronDown className={cn('h-3 w-3 transition-transform duration-200 text-gray-500', isExpanded ? 'rotate-180' : 'rotate-0')} />
                        )}
                    </div>
                </>
            )}
