...
export const DropdownMenu = ({ model = [], trigger, align = 'end', className }) => {
...
export const DropdownMenuLabel = ({ children, className }) => (
    <div className={classNames('px-2 py-1.5 text-sm font-semibold text-gray-900 dark:text-white', className)}>
        {children}
    </div>
);
